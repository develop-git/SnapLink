...
public extension SnapViewDSL {
    ...
    @discardableResult
    func top(_ offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    func safeTop(_ offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    /// 若需要动态修改，将 offset 值设置为 .max/.min
    @discardableResult
    func top(by anchor: ViewYaxisAnchor?, offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    /// 若需要动态修改，将 offset 值设置为 .max/.min
    @discardableResult
    func top(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTop(by anchor: ViewYaxisAnchor?, offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTop(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func topCenterX(by top: AppView, offset: ExtraValue = nil) -> Self {
