...
public extension SnapViewDSL {
    ...
    @discardableResult
    func trailing(_ offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    func safeTrailing(_ offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    @discardableResult
    func trailing(by anchor: ViewXaxisAnchor?, offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    /// 若需要动态修改，将offset值设置为 .max/.min
    @discardableResult
    func trailing(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailing(by anchor: ViewXaxisAnchor?, offset: ExtraValue = .eq(.offset)) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailing(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func trailingCenterY(by trailing: AppView, offset: ExtraValue = nil) -> Self {
...
public extension SnapViewDSL {
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func trailingTop(_ value: ExtraValue = .eq(.offset)) -> Self {
        return self.trailing(value)
            .top(value)
    }
    
    @discardableResult
    func trailingTop(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailingTop(_ value: ExtraValue = .eq(.offset)) -> Self {
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailingTop(by view: AppView, offset: ExtraValue = nil) -> Self {
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func trailingTop(_ trailing: ExtraValue,
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func trailingBottom(_ value: ExtraValue = .eq(.offset)) -> Self {
        return self.trailing(value)
            .bottom(value)
    }
    
    @discardableResult
    func trailingBottom(by view: AppView, offset: ExtraValue = nil) -> Self {
        return self.trailing(by: view, offset: offset)
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailingBottom(_ value: ExtraValue = .eq(.offset)) -> Self {
        return self.safeTrailing(value)
            .safeBottom(value)
    }
    ...
    @discardableResult
    @available(iOS 11.0, macOS 11.0, tvOS 11.0, *)
    func safeTrailingBottom(by view: AppView, offset: ExtraValue = nil) -> Self {
        return self.safeTrailing(by: view, offset: offset)
    ...
    /// 若需要设置视图是否可以压缩显示，可以调用 priority() / compress()方法进行设置
    @discardableResult
    func trailingBottom(_ trailing: ExtraValue,
